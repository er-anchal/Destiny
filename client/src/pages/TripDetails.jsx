  ...
  const fallbackItinerary = [
    {
      ...
      desc: "Arrive at the destination airport or station where our representative will greet you. Transfer to your pre-booked premium hotel and spend the evening at your leisure.",
    },
    {
      day: 2,
      title: "Sightseeing and Exploration",
      desc: "After a complimentary breakfast, embark on a guided tour of the city's most iconic landmarks, historical sites, and vibrant local markets.",
    },
    {
      day: 3,
      title: "Adventure and Local Experiences",
      desc: "Engage in thrilling local activities or opt for a nature excursion. Experience the authentic culture and taste traditional cuisines.",
    },
    {
      day: 4,
      title: "Leisure and Shopping",
      desc: "Enjoy a relaxed morning. Spend the afternoon shopping for souvenirs or exploring hidden gems at your own pace.",
    },
    {
      day: 5,
      title: "Departure",
      desc: "Check out from the hotel and proceed to the airport or station for your onward journey, carrying unforgettable memories.",
    },
  ];
  ...
  return {
    ...
    gallery:
      data.gallery && data.gallery.length > 0
        ? data.gallery
        : [mainImg, mainImg, mainImg, mainImg].filter(Boolean),
    ...
    policies: [
      {
        ...
        rules: [
          "100% Refund if cancelled 30 days prior to departure.",
          "50% Refund if cancelled 15 days prior to departure.",
          "No refund for cancellations within 7 days of trip.",
        ],
      },
      {
        ...
        rules: [
          ...
          "Remaining balance must be cleared 7 days before the trip starts.",
        ],
      },
    ],
  };
            ...
            <div className="mb-12">
              {packageData.itinerary.map((item, idx) => (
                <div key={idx} className="flex gap-4 md:gap-6 mb-8 group relative">
                  ...
                  <div
                    className="flex-1 pt-1 pb-4 cursor-pointer bg-gray-50 rounded-2xl p-5 hover:bg-white hover:shadow-md transition-all border border-gray-100/50"
